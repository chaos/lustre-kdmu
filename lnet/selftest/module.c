...
#define LST_INIT_PARAM          1
#define LST_INIT_RPC            2
#define LST_INIT_FW             3
#define LST_INIT_CONSOLE        4
...
cfs_module(lnet_selftest, "0.9.0", lnet_selftest_init, lnet_selftest_fini);
