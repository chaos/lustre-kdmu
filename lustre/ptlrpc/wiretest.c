...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_padding_2) == 124, " found %lld\n",
        ...
        LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_padding_3) == 128, " found %lld\n",
        ...
        LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_padding_4) == 132, " found %lld\n",
