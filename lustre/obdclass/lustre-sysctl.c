                                     ...
                                     int count, int *eof, void *data)
{
        ...
        cfs_param_get_data(value, data, NULL);
...
static cfs_param_sysctl_table_t cfs_param_obd_table[] = {
        {
                .name   = "fail_loc",
                .data   = &obd_fail_loc,
                .mode   = 0644,
                .read   = cfs_param_fail_loc_read,
                .write  = cfs_param_fail_loc_write
        },
        {
                .name   = "fail_val",
                .data   = &obd_fail_val,
        ...
        },
        {
                ...
                .data   = &obd_timeout,
                .mode   = 0644,
                .read   = cfs_param_timeout_read,
                .write  = cfs_param_timeout_write,
        },
        {
        ...
        },
        {
                ...
                .data   = NULL,
                .mode   = 0444,
                .read   = cfs_param_memory_alloc_read
        },
        {
                .name   = "pagesused",
                .data   = NULL,
                .mode   = 0444,
                .read   = cfs_param_pages_alloc_read
        },
        {
                .name   = "memused_max",
                .data   = NULL,
                .mode   = 0444,
                .read   = cfs_param_mem_max_read
        },
        {
                .name   = "pagesused_max",
                .data   = NULL,
                .mode   = 0444,
                .read   = cfs_param_pages_max_read
        },
        {
                .name   = "ldlm_timeout",
                .data   = &ldlm_timeout,
...
#ifdef RANDOM_FAIL_ALLOC
        {
                ...
                .mode   = 0644,
                .read   = cfs_param_alloc_fail_rate_read,
                .write  = cfs_param_alloc_fail_rate_write
        },
#endif
        {
                .name   = "max_dirty_mb",
                ...
                .mode   = 0644,
                .read   = cfs_param_max_dirty_pages_in_mb_read,
                .write  = cfs_param_max_dirty_pages_in_mb_write
        },
        {
                .name   = "at_min",
                .data   = &at_min,
...
void obd_params_init (void)
{
        ...
        cfs_param_sysctl_init("lustre", cfs_param_obd_table,
                              cfs_param_get_root());
}
